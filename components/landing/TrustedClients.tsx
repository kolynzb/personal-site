...
const TrustedClients = (props: Props) => {
  return (
                ...
                <div className="container">
                  <div className="intro">
                    <h2 className="title text-white">
                      <span className="text-primary">Trusted</span> from Clients
                    </h2>
                    <div className="row row-partners">
                      ...
                      <div className="col-sm-6 col-md-4 col-xl-3 col-partner">
                        <div className="partner-inner">
                          <img alt="" src="images/partners/6.png" />
                        </div>
                      </div>
                      <div className="col-sm-6 col-md-4 col-xl-3 col-partner">
                        <div className="partner-inner">
                          <img alt="" src="images/partners/7.png" />
                        </div>
                      </div>
                      <div className="col-sm-6 col-md-4 col-xl-3 col-partner">
                        <div className="partner-inner">
                          <img alt="" src="images/partners/8.png" />
                        </div>
                      </div>
                      <div className="col-sm-6 col-md-4 col-xl-3 col-partner">
                        <div className="partner-inner">
                          <img alt="" src="images/partners/9.png" />
                        </div>
                      </div>
                      <div className="col-sm-6 col-md-4 col-xl-3 col-partner">
                        <div className="partner-inner">
                          <img alt="" src="images/partners/10.png" />
                        </div>
                      </div>
                      <div className="col-sm-6 col-md-4 col-xl-3 col-partner">
                        <div className="partner-inner">
                          <img alt="" src="images/partners/11.png" />
                        </div>
                      </div>
                      <div className="col-sm-6 col-md-4 col-xl-3 col-partner">
                        <div className="partner-inner">
                          <img alt="" src="images/partners/12.png" />
                        </div>
                      </div>
                    </div>
                  </div>
